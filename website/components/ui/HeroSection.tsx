...
export default function HeroSection({ page }: { page: 'home' | 'partner' | 'affiliates' }) {
  return (
    <section className="flex flex-col items-center justify-between py-12 text-white md:flex-row ">
      {/* Left Side */}
      <div className="max-w-lg space-y-6 flex flex-col items-center lg:items-start">
        ...
        <h1 className="text-4xl font-bold leading-tight text-center lg:text-left">{heroSectionContent[page].title}</h1>
        <p className="text-[#AAACA6] text-center lg:text-left">{heroSectionContent[page].description}</p>
