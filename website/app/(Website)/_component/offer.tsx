...
export default function OfferSection() {
  return (
    <div className="container mx-auto bg-black px-4 py-8 pb-20 md:px-12 md:py-12">
      <div
        className="flex w-full flex-col items-center bg-cover bg-center px-12 py-16 text-center"
        style={{
      ...
      >
        ...
        <h2 className="relative mt-8 px-12 text-2xl font-bold text-white md:text-4xl">
