...
export default function OfferSection() {
    return (
        <div className="bg-black px-6 md:px-20 pb-20">
            <div className="w-full text-center p-16 bg-cover bg-center flex flex-col items-center " style={{ backgroundImage: "url('/images/offer-bg.png')", backgroundSize: "100% 100%", backgroundPosition: "center" }}>
